    ...
    module Trace
      ...
      class Tracer < OpenTelemetry::Trace::Tracer
        ...
        def start_span(name, with_parent: nil, attributes: nil, links: nil, start_timestamp: nil, kind: nil)
          ...
          @tracer_provider.internal_create_span(name, kind, trace_id, parent_span_id, attributes, links, start_timestamp, parent_context, parent_span, @instrumentation_library)
        end
      end
    end
  end
